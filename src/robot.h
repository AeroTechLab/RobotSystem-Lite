...
///
/// Any configuration path must be provided without file extension, and relative to and relative to [<root_dir>](https://github.com/AeroTechLab/RobotSystem-Lite/blob/master/README.md#running)/config/robots/
///
